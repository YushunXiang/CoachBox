...
QT_MOC_LITERAL(3, 16, 4) // "show"

    },
    "SlidePage\0exit\0\0show"
};
...
void SlidePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlidePage::exit)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SlidePage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlidePage::show)) {
                *result = 1;
                return;
            }
        }
